...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvWelcome.text = "Welcome to ${SetupManager.userName(this)}"
        // Long-press the welcome text any time to import from an Excel backup
        tvWelcome.setOnLongClickListener { openImportPicker(); true }
        ...
        findViewById<TextView>(R.id.btnFertigation).setOnClickListener {
            startActivity(Intent(this, FertPlacesActivity::class.java))
        }
        ...
        // Fresh install with an existing backup? Offer restore once.
        if (labours.isEmpty()) {
            AlertDialog.Builder(this)
                .setTitle("Restore data?")
                .setMessage("If you have a previous labour_data.xls backup in Documents/worker_data, you can restore it now.")
